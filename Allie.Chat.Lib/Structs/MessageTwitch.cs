...
{
    /// <summary>
    /// A Twitch Message struct
    /// </summary>
    public struct MessageTwitch : IMessageTwitch
    {
        /// <summary>
        /// The message text
        /// </summary>
        ...
        /// <summary>
        /// The Twitch User that sent the message
        /// </summary>
        public UserTwitchDTO User { get; set; }
        /// <summary>
        ...
        /// </summary>
        public ServerTwitchDTO Server { get; set; }
        /// <summary>
